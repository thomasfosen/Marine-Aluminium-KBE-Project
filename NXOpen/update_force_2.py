# NX 12.0.2.9
# Journal created by tuanat on Mon Mar  9 12:03:25 2020 W. Europe Standard Time
#
import math
import NXOpen
...
def main() : 
    ...
    cAEFace1 = component1.FindObject("PROTO#CAE_Body(113)|CAE_Face(1124)")
    ...
    workSimPart.Expressions.EditWithUnits(expression1, unit1, "9999")
