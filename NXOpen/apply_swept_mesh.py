# NX 12.0.2.9
# Journal created by tuanat on Tue Feb 25 10:44:29 2020 W. Europe Standard Time
#
import math
import NXOpen
import NXOpen.CAE
def main() :
    ...
    mesh3dTetBuilder1.PropertyTable.SetBaseScalarWithDataPropertyValue("quad mesh overall edge size", "48.3", unit1)
    mesh3dTetBuilder1.PropertyTable.SetBaseScalarWithDataPropertyValue("small feature value", "4.83", NXOpen.Unit.Null)


    cAEBody1 = workFemPart.FindObject("CAE_Body(2)")
